...
function loadisotope() {
  ...
  $("img.icon-unlike-search").hover(function () {
    $(this).attr('src', 'wordoftravel/assets/svg/icon-like-liked.svg');
  }, function () {
    $(this).attr('src', 'wordoftravel/assets/svg/icon-like-unliked.svg');
  })
  ...
  $('img#img-item-search').error(function(){
    $(this).attr('src', 'wordoftravel/assets/img/missing.png');
